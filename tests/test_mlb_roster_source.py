...
def test_transactions_do_not_claim_exact_pregame_knowledge():
    frame = normalize_transactions({"transactions": [{"id": 9, "date": "2024-07-30", "effectiveDate": "2024-07-30", "person": {"id": 7}, "toTeam": {"id": 113}, "typeCode": "TR", "typeDesc": "Trade"}]}, season=2024, requested_team_id=113, retrieved_at_utc="2026-07-22T00:00:00Z")
