...
def test_builds_certified_event_and_quarantine_artifacts(tmp_path: Path):
    ...
    transactions = pd.DataFrame(columns=["season", "transaction_id", "player_id", "team_id", "from_team_id", "to_team_id", "effective_date", "transaction_date", "type_code", "type_description", "source_retrieved_at", "source_record_sha256"])
